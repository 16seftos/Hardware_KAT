...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \begin{align}
     ...
     \interp{ \neg \mathsf{R}_{\mathsf{dest}} = \mathsf{R}_0 } (\mathit{is}, \mathit{rs}) 
     &=
     (\mathit{is}, \mathit{rs}) - \interp{ \mathsf{R}_{\mathsf{dest}} = \mathsf{R}_0 } (\mathit{is}, \mathit{rs})\\ %this is a rule using the definition of negation for the next equation.
     (\mathit{is}, \mathit{rs}) - \interp{ \mathsf{R}_{\mathsf{dest}} = \mathsf{R}_0 } (\mathit{is}, \mathit{rs}) 
     &=
     (\mathit{is}', \mathit{rs})
 \end{align}
