...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \end{alignat}
     ...
     Lemma \#1 is used to simplfy the left side of the intersection, and in (\ref{3.2.2:step6}) a result-version of Lemma \#1 is used to simplify the right side of the intersection. (\ref{3.2.2:step8}) contains the evaluated intersection.\\
